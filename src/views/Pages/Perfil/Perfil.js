...
import { Card, CardBody, CardFooter, CardHeader, CardTitle, Col, Form, Row } from 'react-bootstrap'
        ...
        <Row>
            <Col md="12">
                ...
                <CardBody>
                    <Form className="form">
                    <Row>
                        <Col md="6" className='rounded border p-1'>
                            <FormGroup>
                                <label>Empresa</label>
                                <Input
                        ...
                        <Col className="pl-1 rounded border p-1" md="6">
                            <FormGroup>
                                <a href="#pablo" 
                                ...
                                <input type="file" accept='image/*' lang='es' min={1} max={1}
                            ...
                            >
                                <label>Avatar</label>
                                <img src={agente.avatar} alt="avatar" 
                                    style={{width: '260px'}}
                                />
                            </FormGroup>
                        </Col>
                    ...
                    <Row>
                        <Col className="pr-1" md="6">
                            ...
                            <Row>
                                <FormGroup className='d-flex flex-column w-50'>
                                    ...
                                    onChange={(e) => setAgente({...agente, mensaje_notificacion: e.target.checked})}
                                    ></Input>
                                </FormGroup>
                                <FormGroup className='d-flex flex-column w-50'>
                                    ...
                                    onChange={(e) => setAgente({...agente, ver_ultimo_mensaje: e.target.checked})}
                                    ></Input>
                                </FormGroup>
                                {/* ring_tono_mensaje */}
                                <FormGroup className='d-flex flex-column w-50'>
                                    ...
                                    onChange={(e) => setAgente({...agente, ring_tono_mensaje: e.target.checked})}
                                    ></Input>
                                </FormGroup>
                                {/* audio_mensaje */}
                                {
                                    usuario.audio_mensaje && <audio src={agente.audio_mensaje} controls></audio>
                                }
                                <FormGroup className='d-flex flex-column w-50'>
                                    ...
                                    min={1}
                                    max={1}
                                    onChange={(e) => CargarAvatar(e.target.files[0], 'audio_mensaje')}
                                    ></Input>
                                </FormGroup>
                            </Row>
                        </Col>
                        ...
                        <Col className="pl-1" md="2">
                            <FormGroup>
                                ...
                                <>
                                    {dias_laborales && dias_laborales.map((dia, index) => (
                                        <li key={index}>{dia}</li>
                                    ))}
                                </>
                            </FormGroup>
                        ...
                        <Col className="pl-1" md="2">
                            <FormGroup>
                                ...
                                {/* listamos los dia de trabajo en una lista  */}
                                <>
                                    {bot_asignados && bot_asignados.map((dia, index) => (
                                        <li key={index}>{dia}</li>
                                    ))}
                                </>
                            </FormGroup>
                        ...
                        <Col className="pl-1" md="2">
                            <FormGroup>
                                ...
                                {/* listamos los dia de trabajo en una lista  */}
                                <>
                                    {equipos_asignados && equipos_asignados.map((dia, index) => (
                                        <li key={index}>{dia}</li>
                                    ))}
                                </>
                            </FormGroup>
            ...
            <CardFooter className="d-flex justify-content-center">
                <button className="button-bm active" type="submit"
